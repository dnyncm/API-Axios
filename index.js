...
app.post("/", async (req, res) => {
  ...
  const participantsIn = req.body.participants;
  
 const response = await axios.get(`https://bored-api.appbrewery.com/filter?type=${typeIn}&participants=${participantsIn}`);
 const result = response.data;
 console.log(result);
